...
'''
Refines cptm output by taking top 5 words on every topic based on word similary measured using pre-trained word embeddings. 
Run the code as python cptm_refined.py cptm_post_outputfile.txt pretrained_embeddings_file
'''
