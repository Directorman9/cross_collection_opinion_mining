...
Run the code as python cclda_refinement.py embeddings_dictionary inputDir/
Where inputDir is the directory containing cclda post processed outputfiles.txt and embeddings_dictionary is a dictionary containing pretrained embeddings saved to disk using pickles
'''

import codecs, pickle, os, sys
...
#Get topic words from cclda post processed output file
