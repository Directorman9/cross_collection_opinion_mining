...
Run the code as python cclda_coherence_measures.py inputDir/
Where inputDir is the directory containing cclda_refined outputfiles in .txt format.
'''
...
#Get topic words from cclda post processed output files
