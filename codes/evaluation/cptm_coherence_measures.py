...
'''
Measures topic coherance (lcp, pmi, npmi and cosine similarity) for every topic in the given postprocessed cclda output file. 
Run the code as python cptm_coherence_measures.py inputDir/
Where inputDir is the directory containing cptm_refined outputfiles in .txt format.
'''

import codecs, sys, pickle, os, csv, nltk, string
...
#Get topic words from cptm post processed output files
